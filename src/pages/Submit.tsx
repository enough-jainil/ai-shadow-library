...
export default function Submit() {
  ...
  // Use exact redirect URL format expected by GitHub and matching your OAuth app configuration
  const REDIRECT_URI = `${window.location.origin}/auth/github/callback`;

  const { isAuthenticated, createDiscussion, isLoading } = useGitHub();

  const handleGitHubLogin = () => {
    // Make sure the scope includes necessary permissions
...
${author ? `## Author\n${author}` : 'Anonymous'}
  ...
  // Remove unnecessary GitHub callback handling from this component
  // as it's already handled in GitHubCallback.tsx
